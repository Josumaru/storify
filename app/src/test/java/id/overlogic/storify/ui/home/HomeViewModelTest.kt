...
import id.overlogic.storify.DataDummy
import id.overlogic.storify.MainDispatcherRule
...
import id.overlogic.storify.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getPageStory()).thenReturn(expectedQuote)

        val mainViewModel = HomeViewModel(Application(), storyRepository)
        val actualQuote: PagingData<StoryEntity> = mainViewModel.result.getOrAwaitValue()
