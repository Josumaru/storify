package id.overlogic.storify.data.source.remote.mediator
...
import id.overlogic.storify.data.source.local.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getStories(0, page, state.config.pageSize)
            val endOfPaginationReached = !responseData.isSuccessful
            database.withTransaction {
                ...
                val stories: MutableList<StoryEntity> = mutableListOf()
